...
<head>
    ...
    <title>VTP GROUP INTERNATIONALE</title>
                ...
                <div class="row">
                    <div class="col-xxl-3 d-xxl-block d-none">
                        <div class="top-left-header">
                            ...
                            <span class="text-white">Adresse vtp </span>
                        </div>
                    </div>
                            ...
                            <div class="notification-slider">
                                <div>
                                    <div class="timer-notification">
                                        <h6><strong class="me-1">Bienvenue sur vtp !</strong>
                                           <strong class="ms-1">
                                            </strong>
                                        ...
                                        <ul class="navbar-nav">
                                            <li class="nav-item dropdown dropdown-mega">
                                                <a class="nav-link dropdown-toggle ps-xl-2 ps-0"
                                                    href="javascript:void(0)" data-bs-toggle="dropdown">Acceul</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"
                                                    data-bs-toggle="dropdown">Nos produits</a>
                                            ...
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"
                                                    data-bs-toggle="dropdown">Nos vendeurs</a>

                                            </li>

                                            <li class="nav-item dropdown dropdown-mega">
                                                <a class="nav-link dropdown-toggle ps-xl-2 ps-0"
                                                    href="javascript:void(0)" data-bs-toggle="dropdown">Nos livreurs</a>

                                            </li>

                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"
                                                    data-bs-toggle="dropdown">Nos stockeurs</a>
                                              
                                            </li>

                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"
                                                    data-bs-toggle="dropdown">Nos transporteurs</a>
                        ...
                        <div class="service-contain">
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="{{asset('assets/images/product.svg')}}" class="blur-up lazyload" alt="">
                                </div>  
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="{{asset('assets/images/delivery.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="{{asset('assets/images/discount.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="{{asset('assets/images/market.svg')}}" class="blur-up lazyload" alt="">
                                </div>
                ...
                <div class="row g-md-4 g-3">
                    ...
                    <div class="col-xl col-lg-2 col-sm-3">
                        ...
                        <div class="footer-contain">
                            <ul>
                                <li>
                                    <a href="index.html" class="text-content">Acceuil</a>
                                </li>
                                <li>
                                    <a href="shop-left-sidebar.html" class="text-content">Nos produits</a>
                                </li>
                                <li>
